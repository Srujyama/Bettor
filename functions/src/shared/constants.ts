 ...
 *
 * NOTE: This file is a byte-identical COPY of src/shared/constants.ts. Cloud
 * Functions cannot resolve the @/shared path alias, so the pure core is mirrored
 * here. Keep the two in sync so client preview and server settlement agree.
 */
